SKIN_TYPE_SYNONYMS_PT = {
    ...
    "seca": [
        "seca", "ressecada", "ressecamento", "desidratada",
        "descamação", "sem óleo", "sem brilho", "aspecto áspero",
        "pele áspera", "pele que descama", "pele craquelada",
        "pele com coceira", "cútis seca", "pele sem hidratação"
    ],
    ...
    "acneica": [
        "acneica", "propensa a acne", "com acne", "antiacne",
        "propensa a espinhas", "pele acne", "espinhas", "cravos",
        "comedogênica", "pele com cravos", "pele com espinhas",
        "cútis acneica", "anti-espinhas", "controle de acne"
    ],
    ...
    "madura": [
        "madura", "idosa", "envelhecida", "sinais da idade",
        "anti-idade", "antissinais", "com rugas", "flacidez",
        "pele envelhecida", "cútis madura", "linhas de expressão",
        "perda de firmeza", "pele com marcas do tempo"
    ],
    ...
    "com rosacea": [
        "rosacea", "rosácea", "vermelhidão facial", "pele avermelhada",
        "vasos aparentes", "cútis com rosácea", "pele com couperose",
